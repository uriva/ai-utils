...
Deno.test("guardNovelOpaqueIdentifiers strips fabricated user messages from model output", () => {
  const history = [
...
Deno.test("guardNovelOpaqueIdentifiers reclassifies fully fabricated user message to own_thought", () => {
  const history = [
